import { argsSchema } from '/repo/corporation.js';
import { formatRam, scanAllServers } from '/repo/helpers.js';
...
export async function main(ns) {
    ns.tail();
	const scriptName = '/repo/corporation.js';
	const scriptDependencies = ['/repo/helpers.js'];
...
function isFlaggedForDeletion(ns, hostname) {
    return hostname != 'home' && ns.fileExists('/repo/Flags/deleting.txt', hostname);
}
